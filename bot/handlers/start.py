...
# concept comes from @akaza_inst — the credit line below is rendered into
# /start, /help and /profile so attribution is always visible.
# ---------------------------------------------------------------------------
CREDIT_LINE = "🪪 _Bot by_ @akaza\\_inst"
...
def _welcome(name: str | None) -> str:
    ...
    return (
        f"👋 *Hey {who}!*\n\n"
        "I'm *File Bot* — forward me _any_ file (document, video, audio, "
        "voice, sticker, archive, …) and I'll:\n"
        "• stream-download it (no 20 MB Bot-API ceiling)\n"
        "• split it _smartly_ — by size, by count, or auto\n"
